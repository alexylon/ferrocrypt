...
| `recipient/native/{argon2id,x25519}.rs` | Per-type body layout, wrap/unwrap, HKDF info string. Adding a new native recipient is a new submodule plus a `NativeRecipientType` variant. |
