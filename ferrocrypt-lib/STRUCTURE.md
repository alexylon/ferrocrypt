...
- no-clobber finalization:
  - **encryption output and key generation** (file roots, every
    ...
    replacement can produce success. Opening the anchor needs a readable output
